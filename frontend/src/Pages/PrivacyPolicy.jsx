                    ...
                    <div className="container">
                        <div className="row">
                            <div className="policy bg-gray">
                                ...
                                {/* <div>
                                    <h6 className='text-gray'>How we use your information</h6>
                                    <p className='py-2'>We use the information we collect in various ways, including to:</p>
                                    <ul>
                                        <li className='d-flex gap-2'> <GoDotFill className='mt-1' />Provide, operate, and maintain our website</li>
                                        <li className='d-flex gap-2'> <GoDotFill className='mt-1' />Improve, personalize, and expand our website</li>
                                        <li className='d-flex gap-2'> <GoDotFill className='mt-1' />Understand and analyze how you use our website</li>
                                        <li className='d-flex gap-2'> <GoDotFill className='mt-1' />Develop new products, services, features, and functionality</li>
                                        <li className='d-flex gap-2 d-md-none'> <GoDotFill className='mt-1 w-16' />Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes</li>
                                        <li className='d-flex gap-2 d-none d-md-flex'> <GoDotFill className='mt-1 w-6' />Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes</li>
                                        <li className='d-flex gap-2'> <GoDotFill className='mt-1' />Send you emails</li>
                                        <li className='d-flex gap-2'> <GoDotFill className='mt-1' />Find and prevent fraud</li>
                                    </ul>
                                </div> */}
                                <div className='py-3'>
