...
const EditProfile = () => {
  ...
  const fetchLocationDetails = async (pincode) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to fetch location details. Try again later.');
    } finally {
      setLoading(false);
    }
  };
                ...
                <form action="" onSubmit={handleSubmit} className=' p-3'>
                  ...
                  <div className='form-detaile d-flex flex-wrap w-full py-2 d-flex'>
                    ...
                    <div className="col-12 col-md-6 p-2 w-full">
                      ...
                      <div className='my-2'>
                        <label className="block text-md font-medium p-2 text-bold ">Bussiness Detaile</label>
                        <label htmlFor="" className='d-flex align-items-center border border-2 rounded-md p-2 m-1'>
                          <input
                            type="text"
